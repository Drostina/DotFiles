...
awful.screen.connect_for_each_screen(function(s)
    ...
    awful.tag.add("Music", {
        icon               = ".config/awesome/icons/ICO_Spotify.png",
        layout             = awful.layout.suit.tile,
        screen             = s,
        selected           = false,
    })
    ...
    s.mytasklist = awful.widget.tasklist {
        ...
        style    = {
            ...
            shape_border_color = beautiful.shape_border_color;
...
-- Prompt
awful.key({ modkey },            "d",     function () awful.spawn(".config/rofi/launchers/type-6/launcher.sh") end,
